...
namespace SteamCompare.Classes.WebAPI.Interfaces
{
    public class PlayerService : IPlayerService
    {
        ...
        /// <returns></returns>
        public async Task<ISteamWebResponse<OwnedGamesResultContainer>> GetOwnedGamesAsync(ulong steamId, bool? includeAppInfo = true, bool? includeFreeGames = true, IReadOnlyCollection<uint> appIdsToFilter = null)
        {
